    ...
    render() {
        ...
        return (
            <Router>
                    ...
                    <Row gutter={16}>
                        <Col span={8}>
                            <Card hoverable style={{ width: 240 }}
                                actions={[<Link to="/explore/SportsLottery"><Icon type="link" /></Link>, <Icon type="api" onClick={this.handleApi.bind(this, 'chart')} />, <Icon type="ellipsis" />]}>
                ...
                <Route exact path="/"  />
                <Route exact path="/explore/SportsLottery" component={SportsLottery} />
            </Router>
        );
    }
}
